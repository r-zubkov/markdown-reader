...
export const importCopy = {
  ...
  decisions: {
    ...
    replaceHandoffTitle: "Замена подготовлена",
    replaceHandoffDescription: (title: string) => `Замена «${title}» требует безопасного переноса позиции чтения и пока не была выполнена. Исходный документ не изменён.`,
  },
  stages: {
