...
class ReaderRepository implements DocumentRepository {
  ...
  public resolveCurrentAnchor(): Promise<RepositoryResult<{ readonly anchor: { readonly versionId: string; readonly headingPathKey: string; readonly blockOrdinalWithinHeading: number; readonly blockId: string; readonly intraBlockRatio: number; readonly overallSourceRatio: number }; readonly chunkOrdinal: 12; readonly confidence: "exact"; readonly reason: "SAME_VERSION_BLOCK_ID" }>> { return Promise.resolve(ok({ anchor: { blockId: "block-12", blockOrdinalWithinHeading: 12, headingPathKey: "path", intraBlockRatio: 0, overallSourceRatio: 0.63, versionId: "version-id" }, chunkOrdinal: 12, confidence: "exact", reason: "SAME_VERSION_BLOCK_ID" })); }
